...
?>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 style = "margin-top: 70px">Startseite</h1>
<?php
    //Max players
    echo '
    <div class="row">
    ...
    echo        '<p><br><center>Es sind '.$players.' Spieler eingetragen.</p>';
    echo        '</div>';
    echo    '</div>';
    ...
    echo        "<div class='box-panel'><p></p>";
    echo        '<p><br><center>Es existieren '.$vehicles.' Fahrzeuge.</p>';
    echo        '</div>';
    echo    '</div>';
...
$money = '$'.number_format($money, 2);
    ...
    echo        "<div class='box-top'><center><h1>Gesammtgeld</h1></div>";
    echo        "<div class='box-panel'><p></p>";
    echo        '<p><br><center>Auf dem Server existieren '.$money.'.</p>';
    echo        '</div>';
    echo    '</div>';
    ...
    echo        "<div class='box-top'><center><h1>Server neustarten</h1></div>";
    echo        "<div class='box-panel'><p></p>";
    ...
    echo        "<div class='box-top'><center><h1>Globale Nachricht</h1></div>";
    echo        "<div class='box-panel'><p></p>";
    echo            '<form action=home.php method=post>';
    ...
    echo        "<div class='box-top'><center><h1>Server Stoppen</h1></div>";
    echo        "<div class='box-panel'><p></p>";
    echo            '<form action=home.php method=post>';
    ...
    echo        "<div class='box-top'><center><h1>Hilfe</h1></div>";
    echo        "<div class='box-top'><center><h4>Für allgemeine Hilfe auf dem Panel!</h4></div>";
    echo        "<div class='box-panel'><p></p>";
    echo            '<form action=home.php method=post>';
