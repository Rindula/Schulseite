...
switch ($_POST['column']) {
    ...
    case 'color':
        $color = logs($staffPerms['vehicles'], $_POST['column'], $vehicles->pid, $user, $dbcon, $vehicles, $_POST['editval']);
        $UpdateQ = "UPDATE vehicles SET $_POST[column]='$color' WHERE id='$_POST[id]'";
    break;

    case 'pid':
        $pid = logs($staffPerms['vehicles'], $_POST['column'], $vehicles->pid, $user, $dbcon, $vehicles, $_POST['editval']);
        $UpdateQ = "UPDATE vehicles SET $_POST[column]='$pid' WHERE id='$_POST[id]'";
    break;

    case 'type':
        $type = logs($staffPerms['vehicles'], $_POST['column'], $vehicles->pid, $user, $dbcon, $vehicles, $_POST['editval']);
        $UpdateQ = "UPDATE vehicles SET $_POST[column]='$type' WHERE id='$_POST[id]'";
    break;
