...
?>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 style = "margin-top: 70px">Spieler Men&uuml;</h1>
		  <p class="page-header">Spieler-Men&uuml; des Bedienfelds, hier k&ouml;nnen Sie die Datenbankwerte der Spieler &auml;ndern.</p>
          <div id="alert-area"></div>

		  <div class="btn-group" role="group" aria-label="...">
			<FORM METHOD="LINK" ACTION="rCon/player.php">
			<INPUT class='btn btn-primary btn-outline' TYPE="submit" VALUE="Spieler Bannen">
			</FORM>
		  </div>
		  <div class="btn-group" role="group" aria-label="...">
			<FORM METHOD="LINK" ACTION="rCon/unBan.php">
			<INPUT class='btn btn-primary btn-outline' TYPE="submit" VALUE="Spieler Entbannen">
			</FORM>
		  </div>
		  <div class="btn-group" role="group" aria-label="...">
			<FORM METHOD="LINK" ACTION="rCon/Kmenu.php">
			<INPUT class='btn btn-primary btn-outline' TYPE="submit" VALUE="Spieler Kicken">
			</FORM>
		  </div>
		  <div class="btn-group" role="group" aria-label="...">
			<FORM METHOD="LINK" ACTION="notes.php" STYLE = "display: inline;">
			<INPUT class='btn btn-primary btn-outline' TYPE="submit" VALUE="Notiz Menü">
			</FORM>
		  </div>
			...
			<div class="row">
			  <div class="col-lg-6">
				<div class="input-group">
				  <input type="text" class="form-control" style = "width: 300px;" name="SearchValue" placeholder="Spieler Name/UID/ID...">
            ...
            <table class="table table-striped" style = "margin-top: 0px">
              <thead>
                <tr>
					...
					<th>Alias</th>
					<th>UID</th>
					<th><form action = "players.php?search=cash" method="post"><input class='btn-link' type='submit' name='orderCash' value="Spieler Geld (Hand)"></form></th>
					<th><form action = "players.php?search=bank" method="post"><input class='btn-link' type='submit' name='orderBank' value="Spieler Geld (Bank)"></form></th>
					<th><form action = "players.php?search=cop" method="post"><input class='btn-link' type='submit' name='orderCop' value="Polizei Level"></form></th>
