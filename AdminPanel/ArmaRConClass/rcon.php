...
class ARC
{
     ...
     * @param int    $serverPort   Port of the Arma server
     * @param string $RCONpassword RCon password required by BattlEye
     * @param array  $options      Options array of ARC
     */
    public function __construct($serverIP, $serverPort, $RCONpassword, array $options = array())
    {
     ...
     *
     * @param int $player The player who should be kicked
     *
     * @return bool Whether sending the command was successful or not
     */
     ...
     *
     * @param int    $player  Player who is sent the message
     ...
     * @param int    $time   How long the player is banned (0 = permanent)
     *
     * @return bool Whether sending the command was successful or not
     */
     ...
     * Removes a ban.
     *
     * @param int $banid Ban who will be removed
     *
     * @return bool Whether sending the command was successful or not
     */
