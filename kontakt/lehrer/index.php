...
<?php
    ...
    while ($ar = $result->fetch_assoc()) 
    {
        ...
        echo "<tr><td>".$ar["name"]."</td><td>".$ar["vorname"]."</td><td><a class='btn btn-info' href='mailto:".$email."?body=Hallo%20".(($ar["geschlecht"] == "m") ? "Herr" : "Frau")." ".$ar["name"].",%0D%0A%0D%0A'>".(($ar["geschlecht"] == "m") ? "Hr." : "Fr.")." ".$ar["name"]." anschreiben</a></td></tr>";
    }
    echo "</table>";
